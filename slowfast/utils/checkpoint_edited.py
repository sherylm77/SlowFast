...
def load_checkpoint(
    ...
    """
    path_to_checkpoint = 'SLOWFAST_16x8_R50_multigrid.pkl'
    ...
    if convert_from_caffe2:
        with pathmgr.open(path_to_checkpoint, "rb") as f:
            ...
            print(caffe2_checkpoint)
        state_dict = OrderedDict()
        name_convert_func = get_name_convert_func()
        for key in caffe2_checkpoint.keys():
            ...
            if converted_key in ms.state_dict():
                c2_blob_shape = caffe2_checkpoint[key].shape
                ...
                if len(c2_blob_shape) < len(model_blob_shape):
                    ...
                    caffe2_checkpoint[key] = np.reshape(
                        caffe2_checkpoint[key], c2_blob_shape
                    )
                ...
                if (
                    ...
                    caffe2_checkpoint[key] = np.concatenate(
                        [caffe2_checkpoint[key]]
